...
export const ETAPAS_MANIOBRA = {
  APROBACION: 'APROBACION', APROBADO: 'APROBADO',
...
export const ETAPAS_MANIOBRA_ARRAY = [
  'APROBACION', 'APROBADO', 'TRANSITO', 'ESPERA',
  'REVISION', 'LAVADO_REPARACION', 'DISPONIBLE', 'XCARGAR',
  'CARGADO'
];

export const PATIOS = { POLIGONO: 'POLIGONO INDUSTRIAL', UMAN: 'UMAN', SKY: 'SKY PARK', PARAISO: 'PARAÍSO' };
export const PATIOS_ARRAY = ['POLIGONO INDUSTRIAL', 'UMAN', 'SKY PARK', 'PARAÍSO'];
