...
bahia12() {
  ...
  this.ctx.stroke();
  this.ctx.rect(0, 0, 110, 18);
  this.ctx.rect(0, 20, 110, 18);
  this.ctx.rect(0, 40, 110, 18);
  this.ctx.rect(0, 60, 110, 18); 
  this.ctx.rect(0, 80, 110, 18);
}
...
bahia11() {
  ...
  //bahia 11 A
  this.ctx.rect(125, 0, 110, 18);
  
  this.ctx.rect(125, 20, 110, 18);
  
  this.ctx.rect(125, 40, 110, 18);
  
  this.ctx.rect(125, 60, 110, 18);
  
  this.ctx.rect(125, 80, 110, 18);
  
  //bahia 11 B
  
  this.ctx.rect(237, 0, 110, 18);
  
  this.ctx.rect(237, 20, 110, 18);
  
  this.ctx.rect(237, 40, 110, 18);
  
  this.ctx.rect(237, 60, 110, 18);

  this.ctx.rect(237, 80, 110, 18);
...
bahia10() {
  ...
  this.ctx.rect(362, 0, 110, 18);

  this.ctx.rect(362, 20, 110, 18);

  this.ctx.rect(362, 40, 110, 18);

  this.ctx.rect(362, 60, 110, 18);

  this.ctx.rect(362, 80, 110, 18);

  //bahia 10 B

  this.ctx.fillStyle = "red";
  this.ctx.rect(474, 0, 110, 18);

  this.ctx.fillStyle = "red";
  this.ctx.rect(474, 20, 110, 18);

  this.ctx.fillStyle = "red";
  this.ctx.rect(474, 40, 110, 18);

  this.ctx.fillStyle = "red";
  this.ctx.rect(474, 60, 110, 18);

  this.ctx.fillStyle = "red";
  this.ctx.rect(474, 80, 110, 18);
