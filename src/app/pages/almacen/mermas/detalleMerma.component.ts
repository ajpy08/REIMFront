...
@Component({
  ...
  templateUrl: './detalleMerma.component.html',
  styleUrls: ['./detalleMerma.component.css']
})
export class DetalleMermaComponent implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<DetalleMermaComponent>,
  ...
  ngOnInit() {
    ...
    this.materialService.getMateriales('', true, 'I').subscribe(materiales => {
